...
export default function ArticleDetailPage({ params }: ArticleDetailPageProps) {
  ...
  return (
    <div className="min-h-screen p-3 sm:p-6 md:p-8 bg-[#efe4cb] text-[#1c1917] font-serif selection:bg-[#b91c1c] selection:text-white relative overflow-x-hidden">
      ...
      <NewspaperHeader
        tickerItems={[
          `SPECIAL DISPATCH: Reading ${article.headline}`,
          "MUMBAI EDITION: Software Architecture & Engineering Investigation",
      ...
      <article className="max-w-5xl mx-auto py-6 space-y-6">
        ...
        <div className="article-byline flex flex-wrap items-center justify-between text-xs font-mono py-2.5 px-4 bg-[#e4d4b2]/40 border-y-2 border-[#1c1917] text-[#b91c1c]">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <span className="font-black text-[#1c1917]">REPORTED BY {article.author}</span>
        ...
        {article.techStack && article.techStack.length > 0 && (
          <div className="border-2 border-[#1c1917] p-6 bg-[#efe4cb] space-y-3 font-mono">
            <h3 className="text-xs font-bold text-[#b91c1c] uppercase tracking-widest border-b border-[#1c1917]/20 pb-2">
              TECHNICAL SPECIFICATIONS & ARCHITECTURE TAGS
            </h3>
            <div className="flex flex-wrap gap-2 pt-1">
              {article.techStack.map((tech, i) => (
                <span
                  key={i}
                  className="border border-[#1c1917] bg-[#e4d4b2] px-3 py-1 text-xs font-bold text-[#1c1917]"
                >
                  #{tech}
                </span>
              ))}
        ...
        <div className="border-t-2 border-b-4 border-[#1c1917] py-6 grid grid-cols-1 sm:grid-cols-12 gap-4 items-center font-serif">
          ...
          <div className="sm:col-span-9 space-y-2">
            ...
            <p className="text-xs text-[#1c1917]/80 leading-relaxed font-serif">
              Full Stack Developer & AI Integration Engineer based in Mumbai, India. Specialized in building multi-tenant SaaS architectures, Node.js microservices, and modern web applications.
            </p>
        ...
        <section className="pt-6 space-y-4">
          <div className="flex items-center justify-between border-b-2 border-[#1c1917] pb-2">
            <h3 className="text-xs font-mono font-bold text-[#b91c1c] uppercase tracking-widest">
              RELATED INVESTIGATIONS & EDITORIAL DISPATCHES
            </h3>
      ...
      <footer className="max-w-5xl mx-auto border-t-2 border-[#1c1917] pt-6 font-mono text-xs flex flex-wrap items-center justify-between">
        ...
        <div className="text-[10px] text-[#1c1917]/60 uppercase tracking-widest">
          THE ABHISHEK TIMES &bull; EXCLUSIVE ARTICLE EDITION
        </div>
      </footer>
    </div>
  );
